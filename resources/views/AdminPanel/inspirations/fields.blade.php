                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 fv-row fv-plugins-icon-container">
                            <input type='text' name="{{$name}}[title]"
                                ...
                                value="{{isset($ins) && isset($ins->getTranslation($name)->title) ? $ins->getTranslation($name)->title : '' }}">
                            <div
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 fv-row fv-plugins-icon-container">
                            <textarea name="{{$name}}[description]" class="summernote"
                                ...
                                {{ isset($ins) ? $ins->value : '' }}
                                {{ isset($ins) ? $ins->getTranslation($name)->description : '' }}
                            </textarea>
                            <div
                                class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                            </div>
        ...
        <div class="fv-row mb-8">
            ...
            <div class="dz-clickable dropzone" id="kt_modal_create_project_settings_logo">
                ...
                <div class="dz-message needsclick">
                    ...
                    @if( isset($ins) && count($ins->photos) > 0 )
                        @foreach ($ins->photos as  $photo)
                            <div class="dz-preview dz-processing dz-image-preview dz-success dz-complete">
                                <div class="dz-image"><img data-dz-thumbnail="" alt="{{$ins->title}}"
...
<script>
    $('.delete').each(function(e){
        $(this).on('click',function(){
            let button = this;
            $.ajax({
            url :"{{ url(LaravelLocalization::getCurrentLocale().'/inspirations/image/delete/') }}/" + this.getAttribute('data-image-id'),
            type: 'GET',
            headers: {
            '__token':'{{csrf_token()}}',
            },
