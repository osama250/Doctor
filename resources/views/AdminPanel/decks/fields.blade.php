...
<div class="card-body border-top p-9">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 fv-row fv-plugins-icon-container">
                            <input type='text' name="{{$name}}[title]"
                                ...
                                value="{{isset($deck) && isset($deck->getTranslation($name)->title) ? $deck->getTranslation($name)->title : '' }}">
                            <div
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 fv-row fv-plugins-icon-container">
                            <textarea name="{{$name}}[content]" class="summernote"
                                ...
                                {{ isset($deck) ? $deck->value : '' }}
                                {{ isset($deck) ? $deck->getTranslation($name)->content : '' }}
                            </textarea>
                            <div
                                class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                            </div>
  ...
  <div class="fv-row mb-10 fv-plugins-icon-container">
    ...
    <div class="image-input image-input-empty image-input-outline image-input-placeholder" data-kt-image-input="true">
        ...
        <div class="image-input-wrapper w-125px h-125px" @isset($deck->file)
            {{-- style='background-image:url({{asset('images/'.$deck->file)}})' @endisset> --}}
            style='background-image:url( {{ $deck->file }} )' @endisset>
        </div>
