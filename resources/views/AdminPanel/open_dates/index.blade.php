...
<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        ...
        <!--end::Page title-->
        <!--begin::Actions-->
        @if(auth()->user()->can('Add OpenDate'))
        <div class="d-flex align-items-center gap-2 gap-lg-3">

            <!--begin::Primary button-->
            <a href="{{ route('open-dates.create') }}" class="btn btn-sm fw-bold btn-primary">{{ __('lang.create') }}</a>
            <!--end::Primary button-->
        </div>
        @endif
        <!--end::Actions-->
...
<div class="card mb-5 mb-lg-10">
    ...
    <div class="card-body p-0 m-10">
        ...
        <div class="table-responsive" id="kt_datatable">
            @include('AdminPanel.open_dates.table')
        </div>
        <!--end::Table wrapper-->
    </div>
    <!--end::Card body-->
